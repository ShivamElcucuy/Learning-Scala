object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(129); 
  ...
  val hello: String = "Namaste!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  println(hello);$skip(30); 
  val name: String = "Shivam";System.out.println("""name  : String = """ + $show(name ));$skip(24); 
  val name1 = "Elcucuy";System.out.println("""name1  : String = """ + $show(name1 ));$skip(22); 
  val value = 1.12345;System.out.println("""value  : Double = """ + $show(value ));$skip(44); 
  println(name + " " + name1 + " " + value);$skip(179); 
  ...
  println("Here is a mess: " + numberOne + truth + letterA + pi + bigNumber);$skip(56); 
  
  // printf style:
  println(f"Pi is about $pi%.3f");$skip(55); 
  ...
  val storePi = 3.14159265;System.out.println("""storePi  : Double = """ + $show(storePi ));$skip(27); 
  val doublePi = storePi*2;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(28); 
