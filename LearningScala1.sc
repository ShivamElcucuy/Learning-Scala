object LearningScala1 {
  ...
  val name: String = "Shivam"                     //> name  : String = Shivam
  val name1 = "Elcucuy"                           //> name1  : String = Elcucuy
  val value = 1.12345                             //> value  : Double = 1.12345
  println(name + " " + name1 + " " + value)       //> Shivam Elcucuy 1.12345
  ...
  // printf style:
  println(f"Pi is about $pi%.3f")                 //> Pi is about à¥©.à¥§à¥ªà¥¨
  println(f"Zero padding on the left: $numberOne%05d")
                                                  //> Zero padding on the left: à¥¦à¥¦à¥¦à¥¦à¥§
  ...
  val storePi = 3.14159265                        //> storePi  : Double = 3.14159265
  val doublePi = storePi*2                        //> doublePi  : Double = 6.2831853
  println(f"$doublePi%.3f")                       //> à¥¬.à¥¨à¥®à¥©
